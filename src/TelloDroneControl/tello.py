...
class Tello:
    ...
    def move_to_mp(self, x, y, z, speed, mid):
        result = self.send_command('go %s %s %s %s %s' % (x, y, z, speed, mid))
        print(result)
        return result
    def enable_mp(self):
        result = self.send_command('mon')
        print(result)
        result = self.send_command('mdirection 0')
        print(result)
        return result
